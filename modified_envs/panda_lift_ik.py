...
from robosuite.models.tasks import TableTopTask, UniformRandomSampler, UniformSelectiveSampler

import sys
sys.path.append("..")
from ik_module import PandaEEFVelocityController


class PandaLiftIK(PandaEnv):
    """
    ...
    def __init__(
        ...
        self.IK_solver = PandaEEFVelocityController()
