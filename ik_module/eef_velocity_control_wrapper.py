...
class EEFXVelocityControl(Wrapper):
    ...
    # def compensate_for_external_forces(self,action,current_right_hand_pos_eef):
    #     dx_eef =  self.target_next_state - current_right_hand_pos_eef
    #     return action #+ 5*dx_eef[:2]
